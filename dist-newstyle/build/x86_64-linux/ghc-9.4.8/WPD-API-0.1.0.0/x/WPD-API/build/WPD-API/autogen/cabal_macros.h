...
/* package WPD-API-0.1.0.0 */
#ifndef VERSION_WPD_API
#define VERSION_WPD_API "0.1.0.0"
#endif /* VERSION_WPD_API */
#ifndef MIN_VERSION_WPD_API
#define MIN_VERSION_WPD_API(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "WPD-API-0.1.0.0-inplace-WPD-API"
